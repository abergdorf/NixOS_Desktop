...
in {
  ...
  # Automatically copy and chown the bridge registration file before Synapse boots
  systemd.services.matrix-synapse.preStart = ''
    cp -f /var/lib/mautrix-telegram/telegram-registration.yaml /var/lib/matrix-synapse/telegram-registration.yaml
