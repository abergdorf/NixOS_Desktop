...
### MONITORS ###
################
file:/home/andrew/.config/hypr/hyprland.lua
...
hl.on("hyprland.start", function ()
    ...
    hl.exec_cmd("[workspace 2 silent] " .. edit)
...
hl.bind(mainMod .. " + E",      hl.dsp.exec_cmd(edit))
...
hl.bind(mainMod .. " + SHIFT + R", hl.dsp.exec_cmd("sh -c 'pkill noctalia && noctalia'"))
...
-- Switch workspaces & move active window
for i = 1, 10 do
    local key = i % 10
...
-- hl.window_rule({
--     name = "workspace-1-zen",
--     match = { class = "^(zen*)$" },
--     workspace = 1,
-- })

-- hl.window_rule({
--     name = "workspace-2-emacs",
--     match = { class = "^([Ee]macs)$" },
--     workspace = 2,
-- })
#+end_src
...
* MATRIX
  Self hosted Matrix Server using synapse and element
 [[file:matrix.nix]]
** Matrix.nix
*** Base
